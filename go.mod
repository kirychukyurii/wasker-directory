module github.com/kirychukyurii/wasker-directory

go 1.20

require (
	buf.build/gen/go/kirychuk/wasker-proto/grpc/go v1.3.0-20230725163700-93a295087f1f.1
	buf.build/gen/go/kirychuk/wasker-proto/protocolbuffers/go v1.31.0-20230725163700-93a295087f1f.1
